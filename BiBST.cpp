...
BBNode* findBBNode(BBNode* nodo, int x, int y) { 
  ...
  while(esDiferenteARaiz(nodoActual, x, y) && !esNodoVacio(nodoActual)){
      Cuadrante cuadrante;
      ...
      if ( ( x<=nodoActual->kx  ||  y <= nodoActual->ky) && ( x<nodoActual->kx  ||  y < nodoActual->ky)){
        cuadrante= SO;             //    SO
      }
      if ( ( x<=nodoActual->kx  &&  y <= nodoActual->ky) ){
        cuadrante= SO;             //    SO
...
BBNode* insertBBNode(BBNode* nodo, int x, int y) { 
  ...
  while ( !esNodoVacio(nodoActual) && esDiferenteARaiz(nodoActual,x,y)){
    ...
    if (esDiferenteARaiz(nodoActual, x, y ) && ( x<=nodoActual->kx  &&  y <= nodoActual->ky)  ){
      cuadranteASeguir= SO;   
    }
